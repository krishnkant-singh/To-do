<nav class="navbar navbar-expand-lg navbar-dark purple">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form action="SearchServlet" method="post" class="d-flex" role="search">
        <input class="form-control me-2" name="search_id" type="search" placeholder="Search" aria-label="Search">
